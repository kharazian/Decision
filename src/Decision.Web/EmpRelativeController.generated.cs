...
{
    public partial class EmpRelativeController
    {
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        protected EmpRelativeController(Dummy d) { }
        ...
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public EmpRelativeController Actions { get { return MVC.EmpRelative; } }
        [GeneratedCode("T4MVC", "2.0")]
        public readonly string Area = "";
        [GeneratedCode("T4MVC", "2.0")]
        public readonly string Name = "emprelative";
        [GeneratedCode("T4MVC", "2.0")]
        public const string NameConst = "emprelative";
        ...
        public class ViewsClass
        {
            ...
            {
                public readonly string _EmpRelativeItem = "_EmpRelativeItem";
                public readonly string _ListAjax = "_ListAjax";
                public readonly string List = "List";
            }
            public readonly string _EmpRelativeItem = "~/Views/EmpRelative/_EmpRelativeItem.cshtml";
            public readonly string _ListAjax = "~/Views/EmpRelative/_ListAjax.cshtml";
            public readonly string List = "~/Views/EmpRelative/List.cshtml";
        }
    }

    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_EmpRelativeController : Decision.Web.Controllers.EmpRelativeController
    {
        public T4MVC_EmpRelativeController() : base(Dummy.Instance) { }
        ...
        [NonAction]
        partial void ListAjaxOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, Decision.ViewModel.EmpRelative.EmpRelativeSearchRequest request);

        [NonAction]
        public override System.Threading.Tasks.Task<System.Web.Mvc.ActionResult> ListAjax(Decision.ViewModel.EmpRelative.EmpRelativeSearchRequest request)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.ListAjax);
