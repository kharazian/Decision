...
{
    public partial class ExperienceController
    {
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        protected ExperienceController(Dummy d) { }
        ...
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public ExperienceController Actions { get { return MVC.Experience; } }
        [GeneratedCode("T4MVC", "2.0")]
        public readonly string Area = "";
        [GeneratedCode("T4MVC", "2.0")]
        public readonly string Name = "experience";
        [GeneratedCode("T4MVC", "2.0")]
        public const string NameConst = "experience";
        ...
        public class ViewsClass
        {
            ...
            {
                public readonly string _ExperienceItem = "_ExperienceItem";
                public readonly string _ListAjax = "_ListAjax";
                public readonly string List = "List";
            }
            public readonly string _ExperienceItem = "~/Views/Experience/_ExperienceItem.cshtml";
            public readonly string _ListAjax = "~/Views/Experience/_ListAjax.cshtml";
            public readonly string List = "~/Views/Experience/List.cshtml";
        }
    }

    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_ExperienceController : Decision.Web.Controllers.ExperienceController
    {
        public T4MVC_ExperienceController() : base(Dummy.Instance) { }
        ...
        [NonAction]
        partial void ListAjaxOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, Decision.ViewModel.Experience.ExperienceSearchRequest request);

        [NonAction]
        public override System.Threading.Tasks.Task<System.Web.Mvc.ActionResult> ListAjax(Decision.ViewModel.Experience.ExperienceSearchRequest request)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.ListAjax);
