...
{
    public partial class MontlyResultController
    {
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        protected MontlyResultController(Dummy d) { }
        ...
        [GeneratedCode("T4MVC", "2.0")]
        public readonly string Name = "montlyresult";
        [GeneratedCode("T4MVC", "2.0")]
        public const string NameConst = "montlyresult";
    ...
    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_MontlyResultController : Decision.Web.Controllers.MontlyResultController
    {
        public T4MVC_MontlyResultController() : base(Dummy.Instance) { }
        ...
        [NonAction]
        partial void ListAjaxOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, Decision.ViewModel.MontlyResult.MontlyResultSearchRequest request);

        [NonAction]
        public override System.Threading.Tasks.Task<System.Web.Mvc.ActionResult> ListAjax(Decision.ViewModel.MontlyResult.MontlyResultSearchRequest request)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.ListAjax);
